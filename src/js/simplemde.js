...
require("../css/simplemde.css");

// replacing marked and using mardown-it
	...
	.use(require('markdown-it-container'), 'note', {
		...
		render: function (tokens, idx) {
			...
			if (tokens[idx].nesting === 1) {
				// opening tag
				return '<div class="alert alert-info">' + md.utils.escapeHtml(m[1]) + '\n';
...
function togglePreview(editor) {
	...
	if (!preview || !/editor-preview/.test(preview.className)) {
		...
		preview.className = "editor-preview markdown-body"; // allowing github/GFM CSS
